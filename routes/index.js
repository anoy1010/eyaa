...
const Routes = () => {
  ...
  return (
    <NavigationContainer>
        ...
        <Stack.Screen name='StepRegister2' component={FormRegister2} options={{
            headerShown: true,
            headerTitle: '',
            headerLeft: () => <BackIcon />,
          }}/>
          <Stack.Screen name='StepRegister3' component={FormRegister3} options={{
            headerShown: true,
            headerTitle: '',
            headerLeft: () => <BackIcon />,
          }}/>
        ...
        />
        <Stack.Screen name='RegisterMail'component={RMail} options={{
            headerShown: true,
            headerTitle: '',
            headerLeft: () => <BackIcon />,
          }}/>
          <Stack.Screen name='RegisterNumber'component={RNumber} options={{
            headerShown: true,
            headerTitle: '',
            headerLeft: () => <BackIcon />,
          }}/>
          <Stack.Screen name='Formulaire' component={FormRegister} options={{
            headerShown: true,
            headerTitle: '',
            headerLeft: () => <BackIcon />,
          }}/>
